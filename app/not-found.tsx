    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center p-6 overflow-hidden">
            <div className="max-w-md text-center">
                ...
                <div className="mt-6">
                    <Button size="sm" onClick={() => router.push("/")} variant="tableos" className="min-h-[44px] sm:min-h-0">
                        <svg strokeWidth="2" height="2" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
